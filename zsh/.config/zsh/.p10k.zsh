# Generated by Powerlevel10k configuration wizard on 2019-11-02 at 14:26 CET.
...
# angled separators, sharp heads, flat tails, 2 lines, solid, left frame, lightest,
...
() {
  ...
  function prompt_nix() {
    ...
    p10k segment -s $IN_NIX_SHELL -b 250 -f 0 -t "$nixos_logo"
  }

  function instant_prompt_nix() {
    prompt_nix
  }

  typeset -g POWERLEVEL9K_NIX_IMPURE_BACKGROUND=250
  typeset -g POWERLEVEL9K_NIX_PURE_BACKGROUND=white
